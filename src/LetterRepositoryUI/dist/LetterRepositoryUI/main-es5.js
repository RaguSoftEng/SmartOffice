...
var Toast = /** @class */ (function () {
    ...
    Toast.prototype.showNotification = function (_a) {
        var message = _a.message, color = _a.color, time = _a.time, placement = _a.placement;
    ...
    Toast.prototype.Success = function (_a) {
        var message = _a.message, placement = _a.placement;
        $.notify({
            icon: 'notifications',
            message: message
        }, {
    ...
    Toast.prototype.Danger = function (_a) {
        var message = _a.message, placement = _a.placement;
        $.notify({
            icon: 'notifications',
            message: message
    ...
    Toast.prototype.Warning = function (_a) {
        var message = _a.message, placement = _a.placement;
        $.notify({
            icon: 'notifications',
            message: message
    ...
    Toast.prototype.Info = function (_a) {
        var message = _a.message, placement = _a.placement;
        $.notify({
            icon: 'notifications',
            message: message
...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService.prototype.logout = function () {
        ...
        var baseUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].baseUrl + 'Authentication/Logout?token=' + userObj.token;
        return this.http.get(baseUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            return res;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
    };
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(location, element, router, configurationService, authenticationService) {
    ...
    NavbarComponent.prototype.getTitle = function () {
        ...
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.listTitles), _c = _b.next(); !_c.done; _c = _b.next()) {
                var listTitle = _c.value;
    ...
    NavbarComponent.prototype.sideNavbarClose = function () {
    ...
    NavbarComponent.prototype.sideNavbarOpen = function () {
        var sidebar = document.getElementsByClassName('sidebar')[0];
        var sidebarwrapper = document.getElementsByClassName('sidebar-wrapper')[0];
        var mainpanel = document.getElementsByClassName('main-panel')[0];
    ...
    NavbarComponent.prototype.togleSideNav = function () {
...
var SidebarComponent = /** @class */ (function () {
    function SidebarComponent(configurationService) {
        this.configurationService = configurationService;
        this.CurrentUser = JSON.parse(localStorage.getItem('currentUser'));
    }
...
var AdminLayoutComponent = /** @class */ (function () {
    ...
    AdminLayoutComponent.prototype.ngOnInit = function () {
        ...
        this.srouter = this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(function (event) { return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["NavigationEnd"]; })).subscribe(function (event) {
...
var AuthenticationRoutes = _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild(routes);
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(formBuilder, route, router, authenticationService, spinner) {
    ...
    LoginComponent.prototype.enterkeyEvent = function (event) {
        if (event.keyCode == 13) {
            this.onSubmit();
        }
    };
